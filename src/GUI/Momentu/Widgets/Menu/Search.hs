    ...
    do
        ...
        makeSearchTerm mPickFirst
            <&> \term placement ->
                ...
                <&> Widget.eventMapMaker . Lens.mapped %~ traceId "before strongerEvents: "
                <&> Widget.strongerEventsWithoutPreevents (traceId "termEditEventMap: " (term ^. termEditEventMap))
                <&> Widget.eventMapMaker . Lens.mapped %~ traceId "after strongerEvents: "
